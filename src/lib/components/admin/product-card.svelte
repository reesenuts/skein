...
<div class="h-full rounded-xl flex flex-col w-full">
    ...
    <div class="bg-purple/70 backdrop-blur-lg rounded-bl-3xl rounded-br-3xl h-[180px] p-4 flex flex-col justify-between">
      ...
      <div class="flex gap-1">
        ...
        <!-- share button -->
        <button class="bg-light p-3 rounded-xl text-xs flex items-center justify-center text-white w-auto" aria-label="edit">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#352F44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil">
